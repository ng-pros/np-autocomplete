...
angular.module("np-autocomplete-item-template.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("np-autocomplete-item-template.tpl.html",
    "<button type=\"button\" class=\"list-group-item\" ng-repeat=\"item in searchResults\" ng-click=\"select(item)\" ng-bind-html=\"match($eval('item.' + npAutocomplete.nameAttr))\"></button>");
}]);
